...
def blur_face_images(image_base_path):
    # Caffe Model txt model path
    prototxt_path = "C://Users/Muhammad.Mamoon/Documents/EON_EPA_Project/model_location/file_specification.txt"
    
    # Caffe Model Line
    model_path = "C://Users/Muhammad.Mamoon/Documents/EON_EPA_Project/model_location//blurry_model.caffemodel"
    ...
    # img_name = "\\".join(image_base_path.split("\\")[:2])
    # images_dir = os.listdir(img_name)
    # image_path = os.path.join(images_dir, image_base_path.split("\\")[2])
